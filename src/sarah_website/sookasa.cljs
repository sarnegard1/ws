    ...
    [:section
      [:div.flex
        [:div.col-8
          ...
          [:img {:src "https://saraharnegard.files.wordpress.com/2017/06/paper-prototypes.png", :alt "digital prototypes"}]
          ...
          [:img {:src "https://saraharnegard.files.wordpress.com/2017/06/screenshot.pn", :alt "screenshot"}]
