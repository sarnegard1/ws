...
var temp__4657__auto____$1 = goog.object.get(o__37138__auto__,"core");
if(cljs.core.truth_(temp__4657__auto____$1)){
var o__37137__auto__ = temp__4657__auto____$1;
return goog.object.get(o__37137__auto__,"js_reserved_QMARK_");
} else {
return null;
}
} else {
...
try{var o__37125__auto__ = f;
return goog.object.get(o__37125__auto__,"toString").call(o__37125__auto__);
}catch (e39599){var _ = e39599;
return "";
}});
...
try{var o__37125__auto___39602 = t;
goog.object.get(o__37125__auto___39602,"cljs$lang$ctorPrWriter").call(o__37125__auto___39602,t,writer);
}catch (e39601){var __39603 = e39601;
}
...
var char_code = (function (){var o__37125__auto__ = (new String(char$));
return goog.object.get(o__37125__auto__,"charCodeAt").call(o__37125__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__37125__auto__ = String;
return goog.object.get(o__37125__auto__,"fromCharCode").call(o__37125__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__39605 = num_code;
switch (G__39605) {
case (1):
return (185);
...
var o__37125__auto__ = String;
return goog.object.get(o__37125__auto__,"fromCharCode").call(o__37125__auto__,superscript_code);
});
/**
...
}catch (e39611){var e__37150__auto__ = e39611;
return false;
}})())){
...
var vec__39612 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__39612,(0),null);
...
if(cljs.core.truth_(temp__4657__auto__)){
var o__37138__auto__ = temp__4657__auto__;
var temp__4657__auto____$1 = goog.object.get(o__37138__auto__,"dependencies_");
if(cljs.core.truth_(temp__4657__auto____$1)){
var o__37137__auto__ = temp__4657__auto____$1;
return goog.object.get(o__37137__auto__,"nameToPath");
} else {
return null;
}
} else {
...
var len__27054__auto___39621 = arguments.length;
var i__27055__auto___39622 = (0);
while(true){
if((i__27055__auto___39622 < len__27054__auto___39621)){
args__27061__auto__.push((arguments[i__27055__auto___39622]));

var G__39623 = (i__27055__auto___39622 + (1));
i__27055__auto___39622 = G__39623;
continue;
} else {
}
break;
...
devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__39617){
var vec__39618 = p__39617;
var ns_detector = cljs.core.nth.call(null,vec__39618,(0),null);
...
var G__39624 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__39625 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__39624;
remaining_tokens = G__39625;
continue;
}
}
break;
...
devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq39615){
var G__39616 = cljs.core.first.call(null,seq39615);
var seq39615__$1 = cljs.core.next.call(null,seq39615);
return devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(G__39616,seq39615__$1);
});
...
var vec__39633 = cljs.core.split_with.call(null,(function (p1__39629_SHARP_){
return cljs.core.not_EQ_.call(null,p1__39629_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__39633,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__39633,(1),null);
...
var vec__39639 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__39639,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__39639,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__39642 = cljs.core.rest.call(null,remaining_tokens);
var G__39643 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__39642;
name_tokens = G__39643;
continue;
} else {
...
var args39644 = [];
var len__27054__auto___39656 = arguments.length;
var i__27055__auto___39657 = (0);
while(true){
if((i__27055__auto___39657 < len__27054__auto___39656)){
args39644.push((arguments[i__27055__auto___39657]));

var G__39658 = (i__27055__auto___39657 + (1));
i__27055__auto___39657 = G__39658;
continue;
} else {
}
break;
...
var vec__39647 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__39647,(0),null);
var arity = cljs.core.nth.call(null,vec__39647,(1),null);
var vec__39650 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__39650,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__39650,(1),null);
var vec__39653 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__39653,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__39653,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__39653,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__39653,(3),null);
...
var args39660 = [];
var len__27054__auto___39666 = arguments.length;
var i__27055__auto___39667 = (0);
while(true){
if((i__27055__auto___39667 < len__27054__auto___39666)){
args39660.push((arguments[i__27055__auto___39667]));

var G__39668 = (i__27055__auto___39667 + (1));
i__27055__auto___39667 = G__39668;
continue;
} else {
}
break;
...
break;
default:
throw (new Error([cljs.core.str("Invalid arity: "),cljs.core.str(args39660.length)].join('')));
...
var vec__39663 = result;
var munged_ns = cljs.core.nth.call(null,vec__39663,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__39663,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__39663,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__39663,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__39663,(4),null);
var arity = cljs.core.nth.call(null,vec__39663,(5),null);
...
if(cljs.core.truth_(temp__4655__auto__)){
var vec__39676 = temp__4655__auto__;
var munged_name = cljs.core.nth.call(null,vec__39676,(0),null);
var args = cljs.core.nth.call(null,vec__39676,(1),null);
var vec__39679 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__39679,(0),null);
var name = cljs.core.nth.call(null,vec__39679,(1),null);
...
var G__39682 = (arity + (1));
var G__39683 = (function (){var temp__4655__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__4655__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__39684){
var vec__39688 = p__39684;
var arity = cljs.core.nth.call(null,vec__39688,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__39688,(1),null);
...
var fixed_arities = devtools.munging.collect_fn_fixed_arities.call(null,f,(function (){var or__25979__auto__ = max_fixed_arity;
if(cljs.core.truth_(or__25979__auto__)){
return or__25979__auto__;
} else {
...
return cljs.core.get.call(null,arities,p1__39691_SHARP_);
});})(sorted_keys))
,sorted_keys);
...
return (function (p1__39692_SHARP_){
return cljs.core.drop.call(null,(2),p1__39692_SHARP_);
...
var args__27061__auto__ = [];
var len__27054__auto___39699 = arguments.length;
var i__27055__auto___39700 = (0);
while(true){
if((i__27055__auto___39700 < len__27054__auto___39699)){
args__27061__auto__.push((arguments[i__27055__auto___39700]));

var G__39701 = (i__27055__auto___39700 + (1));
i__27055__auto___39700 = G__39701;
continue;
} else {
}
break;
...
var argseq__27062__auto__ = ((((1) < args__27061__auto__.length))?(new cljs.core.IndexedSeq(args__27061__auto__.slice((1)),(0),null)):null);
return devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__27062__auto__);
});

devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__39695){
var vec__39696 = p__39695;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__39696,(0),null);
...
devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq39693){
var G__39694 = cljs.core.first.call(null,seq39693);
var seq39693__$1 = cljs.core.next.call(null,seq39693);
return devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic(G__39694,seq39693__$1);
});
...
var G__39703 = (((arg instanceof cljs.core.Keyword))?arg.fqn:null);
switch (G__39703) {
...
return devtools.munging.args_lists_to_strings.call(null,devtools.munging.arities_to_args_lists.call(null,(function (){var or__25979__auto__ = devtools.munging.collect_fn_arities.call(null,f);
if(cljs.core.truth_(or__25979__auto__)){
return or__25979__auto__;
} else {
...
return [cljs.core.str((cljs.core.truth_((function (){var and__25967__auto__ = include_ns_QMARK_;
...
return [cljs.core.str((cljs.core.truth_(include_protocol_ns_QMARK_)?protocol_ns:null)),cljs.core.str(((!(cljs.core.empty_QMARK_.call(null,protocol_name)))?[cljs.core.str((cljs.core.truth_(include_protocol_ns_QMARK_)?".":null)),cljs.core.str(protocol_name)].join(''):null)),cljs.core.str(((!(cljs.core.empty_QMARK_.call(null,protocol_method)))?[cljs.core.str((cljs.core.truth_((function (){var or__25979__auto__ = include_protocol_ns_QMARK_;
if(cljs.core.truth_(or__25979__auto__)){
return or__25979__auto__;
} else {
...
var map__39710 = options;
var map__39710__$1 = ((((!((map__39710 == null)))?((((map__39710.cljs$lang$protocol_mask$partition0$ & (64))) || (map__39710.cljs$core$ISeq$))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__39710):map__39710);
var include_ns_QMARK_ = cljs.core.get.call(null,map__39710__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__39710__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__39710__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__39710__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__39711 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__39711,(0),null);
var fn_name = cljs.core.nth.call(null,vec__39711,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__39711,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__39711,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__39711,(4),null);
var arity = cljs.core.nth.call(null,vec__39711,(5),null);
...
var protocol_part = (cljs.core.truth_((function (){var and__25967__auto__ = protocol_ns;
if(cljs.core.truth_(and__25967__auto__)){
return cljs.core.not.call(null,(function (){var and__25967__auto____$1 = silence_common_protocols_QMARK_;
...
return [cljs.core.str((function (){var or__25979__auto__ = protocol_part;
if(cljs.core.truth_(or__25979__auto__)){
return or__25979__auto__;
} else {
return fn_part;
...
var o__37125__auto__ = f;
return goog.object.get(o__37125__auto__,"getBasis").call(o__37125__auto__);
});
/**
...
if(cljs.core.truth_((function (){var and__25967__auto__ = goog.isObject(f);
if(cljs.core.truth_(and__25967__auto__)){
...
}catch (e39716){var e__37150__auto__ = e39716;
...
var G__39717 = goog.object.get(obj,cljs.core.first.call(null,path));
var G__39718 = cljs.core.rest.call(null,path);
obj = G__39717;
path = G__39718;
continue;
} else {
...
var partition_bits = (function (){var or__25979__auto__ = goog.object.get(obj,partition_key);
if(cljs.core.truth_(or__25979__auto__)){
return or__25979__auto__;
} else {
return (0);
...
return (function (accum,p__39723){
var vec__39724 = p__39723;
var bit = cljs.core.nth.call(null,vec__39724,(0),null);
var protocol = cljs.core.nth.call(null,vec__39724,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__39727){
var vec__39731 = p__39727;
var ns = cljs.core.nth.call(null,vec__39731,(0),null);
var name = cljs.core.nth.call(null,vec__39731,(1),null);
var selector = cljs.core.nth.call(null,vec__39731,(2),null);
...
var munged_name = cljs.core.nth.call(null,vec__39740,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__39740,(1),null);
...
var sorted_fns = cljs.core.map.call(null,((function (name,sorted_matches,vec__39740,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator){
return (function (p1__39734_SHARP_){
return goog.object.get(obj,cljs.core.first.call(null,p1__39734_SHARP_));
});})(name,sorted_matches,vec__39740,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator))
,sorted_matches);
...
//# sourceMappingURL=munging.js.map?rel=1496854396908