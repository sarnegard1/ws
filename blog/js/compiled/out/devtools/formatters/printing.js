...
var len__27054__auto___39773 = arguments.length;
var i__27055__auto___39774 = (0);
while(true){
if((i__27055__auto___39774 < len__27054__auto___39773)){
args__27061__auto__.push((arguments[i__27055__auto___39774]));

var G__39775 = (i__27055__auto___39774 + (1));
i__27055__auto___39774 = G__39775;
continue;
} else {
}
break;
...
return devtools.formatters.printing.build_markup.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),(arguments[(1)]),argseq__27062__auto__);
});
...
devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq39770){
...
return devtools.formatters.printing.build_markup.cljs$core$IFn$_invoke$arity$variadic(G__39771,G__39772,seq39770__$2);
});
...
if(cljs.core.truth_((function (){var or__25979__auto__ = devtools.formatters.helpers.directly_printable_QMARK_.call(null,value);
...
devtools.formatters.printing.TemplateWriter.cljs$lang$ctorPrWriter = (function (this__26585__auto__,writer__26586__auto__,opt__26587__auto__){
return cljs.core._write.call(null,writer__26586__auto__,"devtools.formatters.printing/TemplateWriter");
});
...
if(cljs.core.truth_((function (){var and__25967__auto__ = cljs.core.not.call(null,devtools.formatters.printing.already_reference_QMARK_.call(null,group));
if(and__25967__auto__){
var or__25979__auto__ = devtools.formatters.helpers.expandable_QMARK_.call(null,obj);
if(cljs.core.truth_(or__25979__auto__)){
return or__25979__auto__;
} else {
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_.call(null,new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__39776_SHARP_){
return cljs.core.some_QMARK_.call(null,cljs.core.meta.call(null,p1__39776_SHARP_));
})))){
...
var map__39785 = opts;
var map__39785__$1 = ((((!((map__39785 == null)))?((((map__39785.cljs$lang$protocol_mask$partition0$ & (64))) || (map__39785.cljs$core$ISeq$))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__39785):map__39785);
var markup_db = cljs.core.get.call(null,map__39785__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
if(cljs.core.truth_((function (){var or__25979__auto__ = (function (){try{if(!((obj == null))){
...
}catch (e39789){var e__37135__auto__ = e39789;
return false;
}})();
if(cljs.core.truth_(or__25979__auto__)){
return or__25979__auto__;
...
}catch (e39791){var e__37135__auto__ = e39791;
return false;
}}
})())){
...
var _STAR_current_state_STAR_39796 = devtools.formatters.state._STAR_current_state_STAR_;
devtools.formatters.state._STAR_current_state_STAR_ = devtools.formatters.state.get_current_state.call(null);

try{var map__39797 = opts;
var map__39797__$1 = ((((!((map__39797 == null)))?((((map__39797.cljs$lang$protocol_mask$partition0$ & (64))) || (map__39797.cljs$core$ISeq$))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__39797):map__39797);
var markup_db = cljs.core.get.call(null,map__39797__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR_39796;
}});
...
;
var temp__4655__auto___39802 = devtools.formatters.state.get_managed_print_level.call(null);
if(cljs.core.truth_(temp__4655__auto___39802)){
var managed_print_level_39803 = temp__4655__auto___39802;
var _STAR_print_level_STAR_39801_39804 = cljs.core._STAR_print_level_STAR_;
cljs.core._STAR_print_level_STAR_ = managed_print_level_39803;

try{devtools.formatters.state.update_current_state_BANG_.call(null,((function (_STAR_print_level_STAR_39801_39804,managed_print_level_39803,temp__4655__auto___39802,writer,opts,job_fn){
return (function (p1__39799_SHARP_){
return devtools.formatters.state.set_managed_print_level.call(null,p1__39799_SHARP_,null);
});})(_STAR_print_level_STAR_39801_39804,managed_print_level_39803,temp__4655__auto___39802,writer,opts,job_fn))
);

job_fn.call(null);
}finally {cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR_39801_39804;
}} else {
job_fn.call(null);
}
...
//# sourceMappingURL=printing.js.map?rel=1496852862343