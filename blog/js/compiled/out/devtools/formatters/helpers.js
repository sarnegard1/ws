...
var G__39745 = devtools.prefs.pref.call(null,v);
v = G__39745;
continue;
} else {
return v;
...
var and__25967__auto__ = cljs.core.not.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"disable-cljs-fn-formatting","disable-cljs-fn-formatting",1903786837)));
if(and__25967__auto__){
var and__25967__auto____$1 = !(cljs.core.var_QMARK_.call(null,value));
...
var or__25979__auto__ = (function (){try{if(!((value == null))){
...
}catch (e39758){var e__37150__auto__ = e39758;
return false;
}})();
if(cljs.core.truth_(or__25979__auto__)){
return or__25979__auto__;
} else {
var or__25979__auto____$1 = (function (){try{if(!((value == null))){
...
}catch (e39762){var e__37150__auto__ = e39762;
return false;
}})();
...
}catch (e39764){var e__37150__auto__ = e39764;
return false;
}}
}
});
devtools.formatters.helpers.cljs_type_QMARK_ = (function devtools$formatters$helpers$cljs_type_QMARK_(f){
var and__25967__auto__ = goog.isObject(f);
if(cljs.core.truth_(and__25967__auto__)){
var and__25967__auto____$1 = cljs.core.not.call(null,devtools.formatters.helpers.is_prototype_QMARK_.call(null,f));
if(and__25967__auto____$1){
...
var and__25967__auto__ = goog.isObject(value);
if(cljs.core.truth_(and__25967__auto__)){
...
var or__25979__auto__ = devtools.formatters.helpers.cljs_instance_QMARK_.call(null,value);
if(cljs.core.truth_(or__25979__auto__)){
return or__25979__auto__;
} else {
...
var and__25967__auto__ = (function (){var or__25979__auto__ = devtools.formatters.helpers.cljs_land_value_QMARK_.call(null,value);
if(cljs.core.truth_(or__25979__auto__)){
return or__25979__auto__;
} else {
...
var vec__39769 = devtools.munging.parse_constructor_info.call(null,constructor_fn);
var ns = cljs.core.nth.call(null,vec__39769,(0),null);
var name = cljs.core.nth.call(null,vec__39769,(1),null);
...
var and__25967__auto__ = devtools.formatters.helpers.cljs_instance_QMARK_.call(null,value);
if(cljs.core.truth_(and__25967__auto__)){
...
var or__25979__auto__ = typeof value === 'string';
if(or__25979__auto__){
return or__25979__auto__;
} else {
var or__25979__auto____$1 = typeof value === 'number';
...
return cljs.core.some.call(null,(function (p1__39772_SHARP_){
return cljs.core._EQ_.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__39772_SHARP_);
}),template);
});
...
if(((!((obj == null)))?((((obj.cljs$lang$protocol_mask$partition0$ & (8388608))) || (obj.cljs$core$ISeqable$))?true:(((!obj.cljs$lang$protocol_mask$partition0$))?cljs.core.native_satisfies_QMARK_.call(null,cljs.core.ISeqable,obj):false)):cljs.core.native_satisfies_QMARK_.call(null,cljs.core.ISeqable,obj))){
...
//# sourceMappingURL=helpers.js.map?rel=1496854397077