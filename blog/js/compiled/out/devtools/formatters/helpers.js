...
var G__39730 = devtools.prefs.pref.call(null,v);
v = G__39730;
continue;
} else {
return v;
...
}catch (e39743){var e__37135__auto__ = e39743;
return false;
}})();
...
}catch (e39747){var e__37135__auto__ = e39747;
return false;
}})();
...
}catch (e39749){var e__37135__auto__ = e39749;
return false;
}}
}
});
...
var vec__39754 = devtools.munging.parse_constructor_info.call(null,constructor_fn);
var ns = cljs.core.nth.call(null,vec__39754,(0),null);
var name = cljs.core.nth.call(null,vec__39754,(1),null);
...
return cljs.core.some.call(null,(function (p1__39757_SHARP_){
return cljs.core._EQ_.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__39757_SHARP_);
}),template);
});
...
//# sourceMappingURL=helpers.js.map?rel=1496852862193